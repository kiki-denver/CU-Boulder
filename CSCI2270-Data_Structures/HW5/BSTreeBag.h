...
namespace hw5
{
    ...
    private:
        ...
        //helpers
        size_type counter(const binary_tree_node<ItemType>* node_ptr, const ItemType& target) const; //I added this function in	
		bool bst_remove(binary_tree_node<ItemType>*& node_ptr, const ItemType& target);
		void bst_remove_max(binary_tree_node<ItemType>*& node_ptr, ItemType& removed);
		bool bst_remove_all(binary_tree_node<ItemType>*& node_ptr, const ItemType& target);
