...
//	    break;
	...
	case '*':
        ...
        case 'I':
            ...
            cin >> b;
            cout << char(current_index + 'A') << ".integral(" << a << ", " << b << "): ";
            cout << p[current_index].definite_integral(a, b) << endl;
            break;
	case 'Q':  // Do nothing..
	    break;
...
void print_menu()
{
    ...
    cout << "- - view A - B" << endl;
    cout << "* - view A * B" << endl;
    cout << "3 - view A == B" << endl;
    cout << "4 - view A != B" << endl;
    cout << "I - view definite integral for current polynomial" << endl;
    cout << "  -   -   -   -   -   -   -   -   -   -   -   -" << endl;
